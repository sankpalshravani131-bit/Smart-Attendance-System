...
class Face_Recognition:
    def __init__(self,root):
        ...
        # 1st image
        img_top=Image.open(r"college_images\face_recognition.jpg")
        ...
        #2nd image
        img_bottom=Image.open(r"college_images\scanning1.jpg")
        ...
        b1_1.place(x=650,y=620,width=200,height=40)

    #===== attendance========

    def mark_attendance(self,i,r,n,d):
        with open("shrawani.csv","r+",newline="\n") as f:
            ...
            for line in myDataList:
                entry=line.split((","))
                entry_list.append((entry[0],entry[5]))
                
            if (i,d1) not in entry_list:
    ...
    def face_recog(self):
        def draw_boundray(img,classifier,scaleFactor,minNeighbors,color,text,clf):
            ...
            for (x,y,w,h) in features:
                ...
                my_cursor.execute('SELECT "dept" FROM student WHERE "Student_id"=%s', (str(id),))
