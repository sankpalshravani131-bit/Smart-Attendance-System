...
from developer import Devlpoer
...
class Face_Recognition_System:
    def __init__(self,root):
      ...
      # 1st image
        img=Image.open(r"college_images\best.jpg")
        ...
        #third image 
        img2=Image.open(r"college_images\ai.jpg")
        ...
        title_lb1=Label(bg_img,text="FACE RECOGNITION ATTENDANCE SYSTEM SOFTWARE",font=("times new roman",35,"bold"),bg="white",fg="dark blue")
        title_lb1.place(x=0,y=0,width=1530,height=45)

        #student button 
        img4=Image.open(r"college_images\images.jpg")
        ...
        #attendance  button
        img6=Image.open(r"college_images\attendace.jpg")
        ...
        b1_1=Button(bg_img,text="Attendance",cursor="hand2",command=self.attendace_data,font=("times new roman",15,"bold"),bg="white",fg="black")
        ...
        # train face button
        img8=Image.open(r"college_images\TRAIN_DATA.jpg")
        ...
        # develpoer button
        img10=Image.open(r"college_images\develpoer.jpg")
        img10=img10.resize((220,220),Image.Resampling.LANCZOS)
        self.photoimg10=ImageTk.PhotoImage(img10)

        b1=Button(bg_img,image=self.photoimg10,cursor="hand2",command=self.develpoer_data)
        b1.place(x=800,y=400,width=220,height=220)

        b1_1=Button(bg_img,text="develpoer",cursor="hand2",command=self.develpoer_data,font=("times new roman",15,"bold"),bg="white",fg="black")
    ...
    def develpoer_data(self):
        self.new_window=Toplevel(self.root)
        self.app=Devlpoer(self.new_window)
